...
type FakeIoTProjects struct {
	Fake *FakeHonoV1alpha1
	ns   string
}

var iotprojectsResource = schema.GroupVersionResource{Group: "hono.eclipse.org", Version: "v1alpha1", Resource: "iotprojects"}

var iotprojectsKind = schema.GroupVersionKind{Group: "hono.eclipse.org", Version: "v1alpha1", Kind: "IoTProject"}
